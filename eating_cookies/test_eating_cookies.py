...
class Test(unittest.TestCase):
    ...
    def test_eating_cookies_large_n(self):
        self.assertEqual(eating_cookies(50, [-1 for i in range(51)]), 10562230626642)
        self.assertEqual(eating_cookies(100, [-1 for i in range(101)]), 180396380815100901214157639)
        self.assertEqual(eating_cookies(500, [-1 for i in range(
